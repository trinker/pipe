...
* new pipe `%B>%` allows browsing the pipe chain step by step

calling `iris %>% head %B>% dim %>% length` will open place you right at the browser call
below
...
* new pipe `%S>%` allows the use of *rlang*'s `!!!` operator to splice dots in
any function 
